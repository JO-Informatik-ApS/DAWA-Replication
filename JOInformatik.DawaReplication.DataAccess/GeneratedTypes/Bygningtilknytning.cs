...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("bygningtilknytning")]
    public partial class Bygningtilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Bygningtilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Bygningspolygonets unikke ID. Heltal.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("bygningid", Order = 0)]
        [Required()]
        public virtual int Bygningid { get; set; }
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Bygningid.ToString() + "_" + Adgangsadresseid.ToString();
                }
                return _dawaPkey;
            }
        }
