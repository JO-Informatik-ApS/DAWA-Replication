...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("supplerendebynavntilknytning")]
    public partial class Supplerendebynavntilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Supplerendebynavntilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Unik ID
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("dagi_id", Order = 1, TypeName = "varchar(7)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Dagi_id.ToString();
                }
                return _dawaPkey;
            }
        }
