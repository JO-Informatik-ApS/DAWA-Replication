...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_navngivenvejpostnummerrelation_aktuel")]
    public partial class Dar_navngivenvejpostnummerrelation_aktuel : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_navngivenvejpostnummerrelation_aktuel()
        {
