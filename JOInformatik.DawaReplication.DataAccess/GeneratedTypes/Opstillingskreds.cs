...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    public partial class Opstillingskreds : ReplicationBase
    {
        ...
        [Column("nummer", TypeName = "varchar(40)")]
        [Required()]
        public virtual string Nummer { get; set; }

        /// <summary>
        /// DETTE ER PKEY. Opstillingskredsens kode. Er unik for hver opstillingskreds. 4 cifre.
        /// </summary>
        ...
        /// <summary>
        /// Valgkredsnummer. Unikt indenfor storkredsen.
        /// </summary>
        
        [Column("valgkredsnummer", TypeName = "varchar(10)")]
        [Required()]
        public virtual string Valgkredsnummer { get; set; }

        /// <summary>
        /// Nummeret på storkredsen, som opstillingskredsen tilhører.
        /// </summary>
        ...
        /// <summary>
        /// Opstillingskredsens kredskommune
        /// </summary>
