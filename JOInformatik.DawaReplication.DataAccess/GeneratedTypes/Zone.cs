...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("zone")]
    public partial class Zone : ReplicationBase
    {
        ...
        /// <summary>
        /// DETTE ER PKEY. "Byzone", "Sommerhusområde" eller "Landzone".
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("zone", TypeName = "varchar(50)")]
        [Required()]
        [JsonProperty(PropertyName = "zone")]
        public virtual string Zone_ { get; set; }
