...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_adressepunkt_historik")]
    public partial class Dar_adressepunkt_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_adressepunkt_historik()
        {
        ...
        [Column("oprindelse_kilde", TypeName = "varchar(40)")]
        public virtual string Oprindelse_kilde { get; set; }

        /// <summary>
        /// Ikke tilgængelig
        /// </summary>
        
        [Column("oprindelse_nøjagtighedsklasse", TypeName = "varchar(1)")]
        public virtual string Oprindelse_nøjagtighedsklasse { get; set; }

        /// <summary>
        /// Ikke tilgængelig
        /// </summary>
        
        [Column("oprindelse_registrering")]
        [Required()]
        public virtual DateTime Oprindelse_registrering { get; set; }

        /// <summary>
        /// Ikke tilgængelig
        /// </summary>
        
        [Column("oprindelse_tekniskstandard", TypeName = "varchar(40)")]
        public virtual string Oprindelse_tekniskstandard { get; set; }
