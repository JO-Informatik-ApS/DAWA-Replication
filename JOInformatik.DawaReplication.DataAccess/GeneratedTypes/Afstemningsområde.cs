...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    public partial class Afstemningsområde : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Afstemningsområde()
        {
        ...
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("nummer", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        ...
        /// <summary>
        /// UUID for afstemningssstedets adgangsadresse.
        /// </summary>
        
        [Column("afstemningsstedadresse", TypeName = "varchar(36)")]
        [Required()]
        public virtual string Afstemningsstedadresse { get; set; }
        ...
        /// <summary>
        /// DAGI id for opstillingskredsen, som afstemningsområdet tilhører
        /// </summary>
        
        [Column("opstillingskreds_dagi_id", TypeName = "varchar(36)")]
        [Required()]
        public virtual string Opstillingskreds_dagi_id { get; set; }
