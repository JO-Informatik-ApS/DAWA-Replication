...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_darsogneinddeling_historik")]
    public partial class Dar_darsogneinddeling_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_darsogneinddeling_historik()
        {
        ...
        [Column("sogneinddeling", TypeName = "varchar(200)")]
        public virtual string Sogneinddeling { get; set; }
