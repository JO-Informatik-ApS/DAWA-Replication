...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_darkommuneinddeling_historik")]
    public partial class Dar_darkommuneinddeling_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_darkommuneinddeling_historik()
        {
        ...
        [Column("kommuneinddeling", TypeName = "varchar(200)")]
        public virtual string Kommuneinddeling { get; set; }
