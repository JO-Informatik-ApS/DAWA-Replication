...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("vask_adresse_historik")]
    public partial class Vask_adresse_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Vask_adresse_historik()
        {
