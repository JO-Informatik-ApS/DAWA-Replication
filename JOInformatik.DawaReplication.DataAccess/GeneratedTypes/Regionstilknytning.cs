...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("regionstilknytning")]
    public partial class Regionstilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Regionstilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Regionens myndighedskode. Er unik for hver region. 4 cifre.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("regionskode", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Regionskode.ToString();
                }
                return _dawaPkey;
            }
        }
