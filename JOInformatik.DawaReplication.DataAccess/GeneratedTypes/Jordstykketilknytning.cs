...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("jordstykketilknytning")]
    public partial class Jordstykketilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Jordstykketilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Ejerlavkoden.
        /// </summary>
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Matrikelnummeret for jordstykket.
        /// </summary>
        ...
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("adgangsadresseid", Order = 2)]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Ejerlavkode.ToString() + "_" + Matrikelnr.ToString() + "_" + Adgangsadresseid.ToString();
                }
                return _dawaPkey;
            }
        }
