...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("bbr_bygningpåfremmedgrund_historik")]
    public partial class Bbr_bygningpåfremmedgrund_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Bbr_bygningpåfremmedgrund_historik()
        {
