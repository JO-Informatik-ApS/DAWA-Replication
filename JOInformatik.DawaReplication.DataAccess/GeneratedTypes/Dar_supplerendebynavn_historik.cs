...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_supplerendebynavn_historik")]
    public partial class Dar_supplerendebynavn_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_supplerendebynavn_historik()
        {
        ...
        [Column("supplerendebynavn1", TypeName = "varchar(200)")]
        public virtual string Supplerendebynavn1 { get; set; }
