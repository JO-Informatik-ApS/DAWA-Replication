...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_navngivenvejsupplerendebynavnrelation_historik")]
    public partial class Dar_navngivenvejsupplerendebynavnrelation_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_navngivenvejsupplerendebynavnrelation_historik()
        {
