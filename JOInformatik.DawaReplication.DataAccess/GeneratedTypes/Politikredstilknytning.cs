...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("politikredstilknytning")]
    public partial class Politikredstilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Politikredstilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Politikredsens myndighedskode. Er unik for hver politikreds. 4 cifre.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("politikredskode", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        public virtual string Politikredskode { get; set; }
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Politikredskode.ToString();
                }
                return _dawaPkey;
            }
        }
