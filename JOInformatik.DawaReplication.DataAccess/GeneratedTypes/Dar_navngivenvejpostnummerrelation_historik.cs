...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_navngivenvejpostnummerrelation_historik")]
    public partial class Dar_navngivenvejpostnummerrelation_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_navngivenvejpostnummerrelation_historik()
        {
