...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("bbr_fordelingaffordelingsareal_historik")]
    public partial class Bbr_fordelingaffordelingsareal_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Bbr_fordelingaffordelingsareal_historik()
        {
