...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("sognetilknytning")]
    public partial class Sognetilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Sognetilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Sognets myndighedskode. Er unik for hvert sogn. 4 cifre.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("sognekode", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Sognekode.ToString();
                }
                return _dawaPkey;
            }
        }
