...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("kommunetilknytning")]
    public partial class Kommunetilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Kommunetilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Kommunens myndighedskode. Er unik for hver kommune. 4 cifre.
        /// </summary>
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Kommunekode.ToString();
                }
                return _dawaPkey;
            }
        }
