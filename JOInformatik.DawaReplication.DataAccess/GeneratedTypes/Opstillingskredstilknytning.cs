...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("opstillingskredstilknytning")]
    public partial class Opstillingskredstilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Opstillingskredstilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Opstillingskredsens kode. Er unik for hver opstillingskreds. 4 cifre.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("opstillingskredskode", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        public virtual string Opstillingskredskode { get; set; }
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Opstillingskredskode.ToString();
                }
                return _dawaPkey;
            }
        }
