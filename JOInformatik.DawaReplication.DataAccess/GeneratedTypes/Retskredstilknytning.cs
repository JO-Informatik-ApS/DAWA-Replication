...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("retskredstilknytning")]
    public partial class Retskredstilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Retskredstilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. Retskredsens myndighedskode. Er unik for hver retskreds. 4 cifre.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("retskredskode", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Retskredskode.ToString();
                }
                return _dawaPkey;
            }
        }
