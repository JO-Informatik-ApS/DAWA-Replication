...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("bbr_fordelingsareal_historik")]
    public partial class Bbr_fordelingsareal_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Bbr_fordelingsareal_historik()
        {
        ...
        /// <summary>
        /// Fordelingsarealets nummer
        /// </summary>
        
        [Column("for002Fordelingsarealnummer")]
        public virtual int? For002Fordelingsarealnummer { get; set; }

        /// <summary>
        /// Arealer som skal fordeles på enheder.
        /// </summary>
        
        [Column("for003ArealTilFordeling")]
        public virtual int? For003ArealTilFordeling { get; set; }

        /// <summary>
        /// Nøgle for fordelingsareal For mulige værdier, se <a href="https://ki.bbr.dk/kodelister-bbr/0/1/0/Fordelingsnoegle">kodelisten.</a>
        /// </summary>
        
        [Column("for004FordelingsNøgle", TypeName = "varchar(90)")]
        public virtual string For004FordelingsNøgle { get; set; }

        /// <summary>
        /// 
        /// </summary>
        
        [Column("for005Navn", TypeName = "varchar(200)")]
        public virtual string For005Navn { get; set; }
        ...
        [Column("for006Rest")]
        public virtual int? For006Rest { get; set; }

        /// <summary>
        /// Beskrivende tekstnotat om særlige forhold for dette BBR-element
        /// </summary>
        
        [Column("for500Notatlinjer", TypeName = "varchar(max)")]
        public virtual string For500Notatlinjer { get; set; }
