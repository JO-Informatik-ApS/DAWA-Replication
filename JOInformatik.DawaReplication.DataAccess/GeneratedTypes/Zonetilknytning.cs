...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("zonetilknytning")]
    public partial class Zonetilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Zonetilknytning()
        {
        ...
        /// <summary>
        /// DETTE ER EN DEL AF PKEY. "Byzone", "Sommerhusområde" eller "Landzone".
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("zone", Order = 1, TypeName = "varchar(20)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Zone.ToString();
                }
                return _dawaPkey;
            }
        }
