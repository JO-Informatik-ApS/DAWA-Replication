...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("region")]
    public partial class Region : ReplicationBase
    {
        ...
        /// <summary>
        /// DETTE ER PKEY. Regionens myndighedskode. Er unik for hver region. 4 cifre.
        /// </summary>
        ...
        /// <summary>
        /// Regionens NUTS2 kode. 
        /// </summary>
        
        [Column("nuts2", TypeName = "varchar(5)")]
        [Required()]
        public virtual string Nuts2 { get; set; }
