...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("storkreds")]
    public partial class Storkreds : ReplicationBase
    {
        ...
        /// <summary>
        /// DETTE ER PKEY. Storkredsens nummer. Heltal. Udgør nøglen.
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("nummer", TypeName = "varchar(10)")]
        [Required()]
        ...
        /// <summary>
        /// Koden på den region som storkredsen ligger i.
        /// </summary>
        ...
        /// <summary>
        /// Bogstav for den valglandsdel, som storkredsen ligger i.
        /// </summary>
