...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("dar_navngivenvejkommunedel_historik")]
    public partial class Dar_navngivenvejkommunedel_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Dar_navngivenvejkommunedel_historik()
        {
