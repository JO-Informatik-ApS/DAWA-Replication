...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("postnummertilknytning")]
    public partial class Postnummertilknytning : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Postnummertilknytning()
        {
        ...
        /// </summary>
        [DatabaseGenerated(DatabaseGeneratedOption.None), Column("postnummer", Order = 1, TypeName = "varchar(4)")]
        [Required()]
        ...
        public override string DawaPkey
        {
            get
            {
                if (_dawaPkey == null)
                {
                    _dawaPkey = Adgangsadresseid.ToString() + "_" + Postnummer.ToString();
                }
                return _dawaPkey;
            }
        }
