...
namespace JOInformatik.DawaReplication.DataAccess
{
    ...
    [Table("bbr_etage_historik")]
    public partial class Bbr_etage_historik : ReplicationBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public Bbr_etage_historik()
        {
        ...
        /// <summary>
        /// Angiver etagebetegnelse på pågælde etage i bygningen.
        /// </summary>
        
        [Column("eta006BygningensEtagebetegnelse", TypeName = "varchar(2)")]
        public virtual string Eta006BygningensEtagebetegnelse { get; set; }

        /// <summary>
        /// Angiver det samlede areal af den pågældende etage.
        /// </summary>
        
        [Column("eta020SamletArealAfEtage")]
        public virtual int? Eta020SamletArealAfEtage { get; set; }

        /// <summary>
        /// Angiver arealet af den del af tagetagen der bliver udnyttet.
        /// </summary>
        
        [Column("eta021ArealAfUdnyttetDelAfTagetage")]
        public virtual int? Eta021ArealAfUdnyttetDelAfTagetage { get; set; }

        /// <summary>
        /// Angiver areal af kælder, hvis loft ligger mindre end 1.25 m over terræn.
        /// </summary>
        
        [Column("eta022Kælderareal")]
        public virtual int? Eta022Kælderareal { get; set; }

        /// <summary>
        /// Angiver arealet af lovlig beboelse i kælder.
        /// </summary>
        
        [Column("eta023ArealAfLovligBeboelseIKælder")]
        public virtual int? Eta023ArealAfLovligBeboelseIKælder { get; set; }

        /// <summary>
        /// Angiver samlet areal af adgangsareal.
        /// </summary>
        
        [Column("eta024EtagensAdgangsareal")]
        public virtual int? Eta024EtagensAdgangsareal { get; set; }

        /// <summary>
        /// Angiver etages type. For mulige værdier, se <a href="https://ki.bbr.dk/kodelister-bbr/0/1/0/EtageType">kodelisten.</a>
        /// </summary>
        
        [Column("eta025Etagetype", TypeName = "varchar(1)")]
        public virtual string Eta025Etagetype { get; set; }

        /// <summary>
        /// Angiver det samlede areal af erhverv i kælder.
        /// </summary>
        
        [Column("eta026ErhvervIKælder")]
        public virtual int? Eta026ErhvervIKælder { get; set; }

        /// <summary>
        /// Beskrivende tekstnotat om særlige forhold for dette BBR-element
        /// </summary>
        
        [Column("eta500Notatlinjer", TypeName = "varchar(max)")]
        public virtual string Eta500Notatlinjer { get; set; }
