...
{
    [Table("dagi__retskredse")]
    public partial class DAGI__Retskredse : DAGIBboxBase
    {
        /// <summary>This constructor calls OnCreated().</summary>
        public DAGI__Retskredse()
        {
        ...
        /// <summary>
        /// Retskredsens myndighedskode. Er unik for hver retskreds. 4 cifre.
        /// </summary>
